...
/**
 * A builder for enchantments, allows for customization of the {@link Enchantment.Rarity enchantment rarity} and
 * {@link EquipmentSlot equipment slots}, and configuration of data associated with
 * enchantments (lang).
 * 
 * @param <T>
...
public class EnchantmentBuilder<T extends Enchantment, P> extends AbstractBuilder<Enchantment, T, P, EnchantmentBuilder<T, P>> {
    ...
    /**
     * Create a new {@link EnchantmentBuilder} and configure data. Used in lieu of adding side-effects to constructor,
     ...
     */
    public static <T extends Enchantment, P> EnchantmentBuilder<T, P> create(AbstractRegistrate<?> owner, P parent, String name, EnchantmentCategory type, EnchantmentFactory<T> factory) {
        return new EnchantmentBuilder<>(owner, parent, name, type, factory)
                .defaultLang();
    }
    ...
    protected EnchantmentBuilder(AbstractRegistrate<?> owner, P parent, String name, EnchantmentCategory type, EnchantmentFactory<T> factory) {
        super(owner, parent, name, ForgeRegistries.Keys.ENCHANTMENTS);
     ...
     * the default, so it is generally not necessary to call, unless for
