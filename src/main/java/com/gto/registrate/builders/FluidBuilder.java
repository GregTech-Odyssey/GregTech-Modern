...
public class FluidBuilder<T extends ForgeFlowingFluid, P> extends AbstractBuilder<Fluid, T, P, FluidBuilder<T, P>> {
     ...
     * and fluid class ({@link ForgeFlowingFluid.Flowing}).
     *
     * @param <P>
     *                       Parent object type
     * @param owner
     ...
     * @see #create(AbstractRegistrate, Object, String, ResourceLocation, ResourceLocation,
     *      FluidTypeFactory, NonNullFunction)
     */
    public static <P> FluidBuilder<ForgeFlowingFluid.Flowing, P> create(AbstractRegistrate<?> owner, P parent, String name, ResourceLocation stillTexture, ResourceLocation flowingTexture) {
        return create(owner, parent, name, stillTexture, flowingTexture, FluidBuilder::defaultFluidType, ForgeFlowingFluid.Flowing::new);
    }
     ...
     *      FluidTypeFactory, NonNullFunction)
     */
    public static <P> FluidBuilder<ForgeFlowingFluid.Flowing, P> create(AbstractRegistrate<?> owner, P parent, String name, ResourceLocation stillTexture, ResourceLocation flowingTexture, FluidTypeFactory typeFactory) {
        return create(owner, parent, name, stillTexture, flowingTexture, typeFactory, ForgeFlowingFluid.Flowing::new);
    }
     ...
     *      FluidTypeFactory, NonNullFunction)
     */
    public static <P> FluidBuilder<ForgeFlowingFluid.Flowing, P> create(AbstractRegistrate<?> owner, P parent, String name, ResourceLocation stillTexture, ResourceLocation flowingTexture, NonNullSupplier<FluidType> fluidType) {
        return create(owner, parent, name, stillTexture, flowingTexture, fluidType, ForgeFlowingFluid.Flowing::new);
    }
     ...
     * @return A new {@link FluidBuilder} with reasonable default data generators.
     */
    public static <T extends ForgeFlowingFluid, P> FluidBuilder<T, P> create(AbstractRegistrate<?> owner, P parent, String name, ResourceLocation stillTexture, ResourceLocation flowingTexture,
                                                                             NonNullFunction<ForgeFlowingFluid.Properties, T> fluidFactory) {
        return create(owner, parent, name, stillTexture, flowingTexture, FluidBuilder::defaultFluidType, fluidFactory);
    }
    ...
    public static <T extends ForgeFlowingFluid, P> FluidBuilder<T, P> create(AbstractRegistrate<?> owner, P parent, String name, ResourceLocation stillTexture, ResourceLocation flowingTexture,
        ...
        FluidBuilder<T, P> ret = new FluidBuilder<>(owner, parent, name, stillTexture, flowingTexture, typeFactory, fluidFactory)
    ...
    public static <T extends ForgeFlowingFluid, P> FluidBuilder<T, P> create(AbstractRegistrate<?> owner, P parent, String name, ResourceLocation stillTexture, ResourceLocation flowingTexture,
        ...
        FluidBuilder<T, P> ret = new FluidBuilder<>(owner, parent, name, stillTexture, flowingTexture, fluidType, fluidFactory)
                .defaultLang().defaultSource().defaultBlock().defaultBucket();
        return ret;
    }
    ...
    public FluidBuilder(AbstractRegistrate<?> owner, P parent, String name, ResourceLocation stillTexture, ResourceLocation flowingTexture, FluidTypeFactory typeFactory, NonNullFunction<ForgeFlowingFluid.Properties, T> fluidFactory) {
    ...
    public FluidBuilder(AbstractRegistrate<?> owner, P parent, String name, ResourceLocation stillTexture, ResourceLocation flowingTexture, NonNullSupplier<FluidType> fluidType, NonNullFunction<ForgeFlowingFluid.Properties, T> fluidFactory) {
        super(owner, parent, "flowing_" + name, ForgeRegistries.Keys.FLUIDS);
        this.sourceName = name;
        this.bucketName = name + "_bucket";
        this.stillTexture = stillTexture;
