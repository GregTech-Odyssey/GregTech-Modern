...
public class Object2IntMapAccess<K> extends AbstractMarkFieldAccess<Object2IntMap> {
    ...
    @Override
    public void writeBuffer(@NotNull LogicalSide side, @NotNull Object2IntMap instance, @NotNull FriendlyByteBuf data, boolean force) {
    ...
    @Override
    public void readBuffer(@NotNull LogicalSide side, @NotNull Object2IntMap instance, @NotNull FriendlyByteBuf data) {
    ...
    @Override
    public @NotNull Data writeData(@NotNull Object2IntMap instance) {
    ...
    @Override
    public void readData(@NotNull Object2IntMap instance, @NotNull Data data) {
