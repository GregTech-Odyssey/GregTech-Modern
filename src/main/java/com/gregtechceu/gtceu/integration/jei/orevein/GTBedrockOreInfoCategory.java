...
public class GTBedrockOreInfoCategory extends ModularUIRecipeCategory<GTBedrockOreInfoWrapper> {
    ...
    public static final RecipeType<GTBedrockOreInfoWrapper> RECIPE_TYPE = new RecipeType<>(GTCEu.id("bedrock_ore_diagram"), GTBedrockOreInfoWrapper.class);
    ...
    public static void registerRecipes(IRecipeRegistration registry) {
        registry.addRecipes(RECIPE_TYPE, ClientProxy.CLIENT_BEDROCK_ORE_VEINS.values().stream().map(GTBedrockOreInfoWrapper::new).toList());
    }
