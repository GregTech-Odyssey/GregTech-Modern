...
public class LangHandler {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("metaarmor.gto.hint.shift", "Hold Shift for details");
        provider.add("metaarmor.gto.section.protection", "Protection");
        provider.add("metaarmor.gto.section.features", "Features");
        provider.add("metaarmor.gto.section.space", "Space");
        provider.add("metaarmor.gto.capacity", "Capacity 1A × %s h (%s)");
        provider.add("metaarmor.gto.protection.piece", "Piece  Armor %s · Toughness %s · Knockback Resistance %s");
        provider.add("metaarmor.gto.protection.set", "Set  Armor %s · Toughness %s · Knockback Resistance %s");
        provider.add("metaarmor.gto.detail.full_power", "Protection falls back to unpowered values when the charge runs out");
        provider.add("metaarmor.gto.detail.unpowered_piece", "Unpowered piece: armor %s, toughness %s");
        provider.add("metaarmor.gto.detail.unpowered_set", "Unpowered set: armor %s, toughness %s");
        provider.add("metaarmor.gto.detail.set_definition", "Set: helmet, leggings and boots of the same line plus this chestplate");
        provider.add("metaarmor.gto.detail.set_effect", "Hits below 20 damage deal %s; resists %s of armor shred and pierce");
        provider.add("metaarmor.gto.state.piece", "Piece passive");
        provider.add("metaarmor.gto.state.set", "Set passive");
        provider.add("metaarmor.gto.state.need_set", "Requires full set");
        provider.add("metaarmor.gto.state.no_energy", "Insufficient energy");
        provider.add("metaarmor.gto.state.on", "Enabled");
        provider.add("metaarmor.gto.state.off", "Disabled");
        provider.add("metaarmor.gto.state.on_but", "Enabled · %s");
        provider.add("metaarmor.gto.state.unbound", "[Key not bound]");
        provider.add("metaarmor.gto.state.oxygen_active", "Supplying");
        provider.add("metaarmor.gto.state.oxygen_ready", "Available");
        provider.add("metaarmor.gto.state.oxygen_empty", "No oxygen");
        provider.add("metaarmor.gto.reason.no_energy", "insufficient energy");
        provider.add("metaarmor.gto.key", "[%s]");
        provider.add("metaarmor.gto.key_or_shift_use", "[%s / Sneak + Use]");
        provider.add("metaarmor.gto.cost.per_damage", "%s/3600 A·h per damage");
        provider.add("metaarmor.gto.cost.per_use", "%s/3600 A·h per use");
        provider.add("metaarmor.gto.cost.per_effect", "Charged per effect");
        provider.add("metaarmor.gto.cost.per_jump", "%s/3600 A·h per jump");
        provider.add("metaarmor.gto.cost.transferred", "Energy transferred");
        provider.add("metaarmor.gto.cost.oxygen", "%s mB oxygen per second");
        provider.add("metaarmor.gto.feature.damage_drain", "Damage absorption");
        provider.add("metaarmor.gto.feature.step_assist", "Step assist");
        provider.add("metaarmor.gto.feature.ppe", "Hazard protection");
        provider.add("metaarmor.gto.feature.breath", "Breath supply");
        provider.add("metaarmor.gto.feature.auto_eat", "Auto-feeding");
        provider.add("metaarmor.gto.feature.cleanse", "Effect blocking");
        provider.add("metaarmor.gto.feature.fire_immune", "Fire immunity");
        provider.add("metaarmor.gto.feature.freeze_immune", "Freeze immunity");
        provider.add("metaarmor.gto.feature.boosted_jump", "Boosted jump");
        provider.add("metaarmor.gto.feature.jetpack", "Jetpack flight");
        provider.add("metaarmor.gto.feature.hover", "Hover");
        provider.add("metaarmor.gto.feature.emergency_hover", "Emergency hover");
        provider.add("metaarmor.gto.feature.charge_items", "Inventory charging");
        provider.add("metaarmor.gto.feature.space_protection", "Space protection");
        provider.add("metaarmor.gto.feature.underwater_breath", "Oxygen breathing");
        provider.add("metaarmor.gto.detail.step_assist", "Steps up full blocks; disabled while sneaking");
        provider.add("metaarmor.gto.detail.ppe", "Effective when every slot a hazard requires holds protective gear");
        provider.add("metaarmor.gto.detail.breath", "Restores breath when it runs low underwater");
        provider.add("metaarmor.gto.detail.auto_eat", "Eats food from the inventory when hungry");
        provider.add("metaarmor.gto.detail.cleanse_costs", "Per level (/3600 A·h): Poison %s, Wither %s, Nausea %s, Mining Fatigue %s, Slowness %s, Bad Luck %s");
        provider.add("metaarmor.gto.detail.boosted_jump", "Increases jump height and distance");
        provider.add("metaarmor.gto.detail.jetpack", "Horizontal flight speed scales with the leggings speed multiplier");
        provider.add("metaarmor.gto.detail.emergency_hover", "Engages hover automatically when falling into the void or taking a lethal fall");
        provider.add("metaarmor.gto.detail.charge_items", "Charges electric items in the inventory and armor slots, drawing the energy transferred");
        provider.add("metaarmor.gto.detail.no_nightvision", "No night vision: in GTO, night vision is a per-player toggle key");
        provider.add("metaarmor.gto.detail.space_protection", "Requires NanoMuscle or QuarkTech pieces in all four slots and oxygen in this chestplate; immune to vacuum, acid rain and extreme temperatures");
        provider.add("metaarmor.gto.detail.underwater_breath", "Consumes stored oxygen to restore breath underwater");
        provider.add("metaarmor.gto.name.jetpack", "Jetpack flight");
        provider.add("metaarmor.gto.name.hover", "Hover");
        provider.add("metaarmor.gto.name.emergency_hover", "Emergency hover");
        provider.add("metaarmor.gto.name.charge_items", "Inventory charging");
        provider.add("metaarmor.gto.name.boosted_jump", "Boosted jump");
        provider.add("metaarmor.gto.toggle.on", "enabled");
        provider.add("metaarmor.gto.toggle.off", "disabled");
        provider.add("metaarmor.gto.toggle.on_ineffective", "enabled, but inactive due to %s");
        provider.add("metaarmor.gto.toggle.emergency_triggered", "Emergency hover triggered; flight and hover enabled");
        provider.add("metaarmor.gto.feature.speed_boost", "Speed multiplier");
        provider.add("metaarmor.gto.name.speed_boost", "Speed multiplier");
        provider.add("metaarmor.gto.state.speed", "%s×");
        provider.add("metaarmor.gto.state.speed_but", "%s× · %s");
        provider.add("metaarmor.gto.toggle.speed_ineffective", "%s×, but inactive due to %s");
        provider.add("metaarmor.gto.detail.speed_levels", "Levels: %s. Draws energy only while moving; also applies to flight");
        provider.add("metaarmor.gto.detail.speed_level", "%s× %s A/s");
        provider.add("metaarmor.gto.separator", ", ");
        provider.add("metaarmor.gto.cost.amps_per_second", "%s A/s");
        provider.add("metaarmor.gto.feature.radiation", "Radiation protection");
        provider.add("metaarmor.gto.detail.radiation", "Protects against the carcinogenic hazard of radioactive materials such as uranium and plutonium when all four slots hold protective gear");
        provider.add("metaarmor.gto.section.gaia", "Gaia Guardian");
        provider.add("metaarmor.gto.feature.life_boost", "Life boost");
        provider.add("metaarmor.gto.name.life_boost", "Life boost");
        provider.add("metaarmor.gto.detail.life_boost", "Max health +%s for this piece, +%s for the full set");
        provider.add("metaarmor.gto.feature.env_instant", "Impact damage offset");
        provider.add("metaarmor.gto.detail.env_instant", "Fall, lightning, flying into walls and falling anvils; drains energy per damage point and negates the damage");
        provider.add("metaarmor.gto.feature.env_continuous", "Sustained damage offset");
        provider.add("metaarmor.gto.detail.env_continuous", "Fire and lava, drowning, freezing, suffocation, cramming, starvation and cactus; drains energy per damage point and negates the damage");
        provider.add("metaarmor.gto.feature.timed_cleanse", "Periodic cleansing");
        provider.add("metaarmor.gto.detail.timed_cleanse", "Removes all harmful potion effects every 2 seconds, charged per effect level");
        provider.add("metaarmor.gto.cost.per_level", "%s/3600 A·h per level");
        provider.add("metaarmor.gto.feature.regen", "Regeneration");
        provider.add("metaarmor.gto.detail.regen", "Restores 1 health every 4/3 seconds while injured");
        ...
        provider.add("metaarmor.gto.detail.energy_blade_drain", "Draws energy only while held in the main hand; the percentage damage is applied after armor");
        provider.add("metaarmor.gto.shift_use", "[Sneak + Use]");
        provider.add("metaarmor.gto.saber.damage", "Attack damage %s");
        provider.add("metaarmor.gto.saber.health_percent", "Max-health bonus damage %s");
        provider.add("metaarmor.gto.saber.range", "Attack range %s blocks");
        provider.add("metaarmor.gto.saber.speed", "Attack speed %s");
        provider.add("metaarmor.gto.state.blade_off", "Energy blade disabled");
        provider.add("metaarmor.gto.detail.energy_blade", "Active: %s attack damage, bonus damage equal to %s of the target’s max health, %s-block range; disabled or out of energy: %s attack damage, no bonus damage, %s-block range");
        provider.add("metaarmor.gto.detail.powered_piece", "Powered piece: armor %s, toughness %s, knockback resistance %s");
        provider.add("metaarmor.gto.detail.powered_set", "Powered set: armor %s, toughness %s, knockback resistance %s");
        ...
        provider.add("behaviour.memory_card.gto.setting.auto_output", "Auto Output");
        provider.add("behaviour.memory_card.gto.setting.input_from_output", "Input from Output Side");
        provider.add("behaviour.memory_card.gto.setting.muffled", "Muffled");
        provider.add("behaviour.memory_card.gto.usage.copy", "Sneak + Right-click a machine: copy its settings");
        provider.add("behaviour.memory_card.gto.usage.paste", "Right-click a machine: paste settings");
        provider.add("behaviour.memory_card.gto.usage.clear", "Sneak + Right-click the air: clear stored settings");
        provider.add("behaviour.memory_card.gto.details.relative", "Output sides are stored relative to the machine front; pasting onto a machine facing another way rotates them to the matching side");
        provider.add("behaviour.memory_card.gto.details.skip", "Item and fluid settings are stored separately; settings the target machine lacks are skipped");
        provider.add("behaviour.memory_card.gto.details.not_copied", "Not copied: covers, programmed circuit, machine facing");
        ...
        provider.add("gtceu.multiblock.universal.distinct", "Distinct Part:");
        ...
        provider.add("gtceu.key.armor_speed", "Armor Speed Multiplier");
        provider.add("gtceu.key.armor_life", "Armor Life Boost");
        ...
        provider.add("gtceu.gui.filter.empty", "No filter");
        provider.add("cover.advanced_energy_detector.inverted.tooltip", "Off: outputs 15 when energy is at or below the minimum and 0 when at or above the maximum; between the two, the current output is kept. On: the two outputs are swapped.");
        provider.add("cover.advanced_energy_detector.mode.tooltip", "Compares stored energy with the thresholds as an EU amount or as a percentage of capacity");
        provider.add("cover.advanced_detector.inverted.tooltip", "Off: 0 at or below the minimum, 15 at or above the maximum, proportional in between. On: the signal is reversed.");
        provider.add("cover.advanced_detector.latched.tooltip", "When on, the output is either 0 or 15: 15 once the amount drops to the minimum or below, 0 once it reaches the maximum or above, unchanged in between. Inverted output swaps the two.");
        provider.add("cover.machine_controller.inverted.tooltip", "Off: the target runs while the input signal is below the minimum strength and pauses once it is reached. On: the target runs only while the input signal is at or above the minimum strength.");
        provider.add("cover.ui.transfer", "Transfer Settings");
        provider.add("cover.ui.modes", "Modes");
        provider.add("cover.ui.io", "Direction");
        provider.add("cover.ui.manual_io", "Manual I/O");
        provider.add("cover.ui.voiding", "Voiding");
        provider.add("cover.ui.voiding.enabled", "Enable Voiding");
        provider.add("cover.conveyor.ui.transfer_rate", "Transfer Rate (items/s)");
        provider.add("cover.conveyor.ui.io.tooltip", "Import: moves items from the adjacent block into this block. Export: moves items from this block to the adjacent block.");
        provider.add("cover.conveyor.ui.distribution", "Distribution");
        provider.add("cover.conveyor.ui.distribution_no_pipe", "Applies only when this block or the adjacent block is an item pipe");
        provider.add("cover.conveyor.ui.amount_from_filter", "The current filter specifies the amounts");
        provider.add("cover.robotic_arm.ui.transfer_mode", "Transfer Mode");
        provider.add("cover.robotic_arm.ui.supply_amount", "Supply Amount");
        provider.add("cover.robotic_arm.ui.keep_amount", "Keep Amount");
        provider.add("cover.robotic_arm.ui.amount.tooltip", "Used when no filter is installed or the filter does not specify amounts. Otherwise the amounts set in the filter apply.");
        provider.add("cover.robotic_arm.ui.amount_unused", "Not used in Transfer Any mode");
        provider.add("cover.item_voiding.ui.mode", "Voiding Mode");
        provider.add("cover.item_voiding.ui.keep_amount", "Amount to Keep");
        provider.add("cover.item_voiding.ui.keep_amount.tooltip", "In Void Overflow mode, items beyond this amount are voided. When a whitelist filter is installed, the amounts set in the filter apply.");
        provider.add("cover.item_voiding.ui.amount_unused", "Not used in Void Matching mode");
        provider.add("cover.pump.ui.transfer_rate", "Transfer Rate (%s/t)");
        provider.add("cover.fluid_regulator.ui.regulation", "Regulation");
        provider.add("cover.fluid_regulator.ui.transfer_mode", "Transfer Mode");
        provider.add("cover.fluid_regulator.ui.supply_amount", "Supply Amount (%s)");
        provider.add("cover.fluid_regulator.ui.keep_amount", "Keep Amount (%s)");
        provider.add("cover.fluid_regulator.ui.amount_unused", "Not used in Transfer Any mode");
        provider.add("cover.fluid_regulator.ui.amount_from_filter", "Set per fluid by the filter");
        provider.add("cover.fluid.voiding.ui.mode_settings", "Voiding Mode");
        provider.add("cover.fluid.voiding.ui.mode", "Mode");
        provider.add("cover.fluid.voiding.ui.keep_amount", "Keep Amount (%s)");
        provider.add("cover.fluid.voiding.ui.amount_unused", "Only used in Void Overflow mode");
        provider.add("cover.fluid.voiding.ui.amount_from_filter", "Set per fluid by the whitelist filter");
        provider.add("cover.filter.mode.title", "Filter Mode");
        provider.add("cover.item_smart_filter.target_machine", "Target Machine");
        provider.add("cover.tag_filter.lookup_item", "Insert an item to view its tags");
        provider.add("cover.tag_filter.lookup_fluid", "Click with a fluid container or drag a fluid from EMI to view its tags");
        provider.add("cover.tag_filter.lookup_only", "For lookup only; does not affect filtering");
        provider.add("behavior.item_magnet.filter_type", "Filter Type");
        provider.add("cover.advanced_detector.output", "Output");
        provider.add("cover.advanced_detector.thresholds", "Thresholds");
        provider.add("cover.advanced_detector.inverted", "Inverted Output");
        provider.add("cover.advanced_detector.latched", "Latched Mode");
        provider.add("cover.advanced_energy_detector.mode", "Compare By");
        provider.add("cover.advanced_energy_detector.mode.eu", "EU");
        provider.add("cover.advanced_energy_detector.mode.percent", "Percentage");
        provider.add("cover.advanced_energy_detector.min.eu", "Min (EU)");
        provider.add("cover.advanced_energy_detector.max.eu", "Max (EU)");
        provider.add("cover.advanced_energy_detector.min.percent", "Min (%%)");
        provider.add("cover.advanced_energy_detector.max.percent", "Max (%%)");
        provider.add("cover.machine_controller.section.target", "Target");
        provider.add("cover.machine_controller.section.signal", "Redstone");
        provider.add("cover.machine_controller.min_strength", "Min Redstone Strength");
        provider.add("cover.machine_controller.target.machine", "Machine");
        provider.add("cover.machine_controller.target.cover_up", "Top Cover");
        provider.add("cover.machine_controller.target.cover_down", "Bottom Cover");
        provider.add("cover.machine_controller.target.cover_north", "North Cover");
        provider.add("cover.machine_controller.target.cover_east", "East Cover");
        provider.add("cover.machine_controller.target.cover_south", "South Cover");
        provider.add("cover.machine_controller.target.cover_west", "West Cover");
        provider.add("cover.machine_controller.target_unavailable", "No controllable target");
        provider.add("cover.machine_controller.status.target", "Controlled");
        provider.add("cover.machine_controller.status.signal", "Input Signal");
        provider.add("cover.machine_controller.status.working", "Target State");
        provider.add("cover.machine_controller.status.none", "None");
        provider.add("cover.machine_controller.status.missing", "Not found");
        provider.add("cover.machine_controller.status.enabled", "Running allowed");
        provider.add("cover.machine_controller.status.paused", "Paused");
        provider.add("cover.ender_link.permission.public", "Public: channels shared by all players");
        provider.add("cover.ender_link.permission.private", "Private: channels of the machine owner");
        provider.add("cover.ender_link.ui.channel", "Channel");
        provider.add("cover.ender_link.ui.permission", "Access");
        provider.add("cover.ender_link.ui.channel_name.tooltip", "Channel name: 8-digit hex color (RRGGBBAA); missing digits are filled with F. Press Enter to apply");
        provider.add("cover.ender_link.ui.description.placeholder", "Channel description");
        provider.add("cover.ender_link.ui.description.tooltip", "Shown in the channel list. Channels with a description are kept when no cover uses them");
        provider.add("cover.ender_link.ui.open_list", "Channel List");
        provider.add("cover.ender_link.ui.private_no_access", "Private channels are limited to the machine owner and their team");
        provider.add("cover.ender_link.ui.working", "Enabled");
        provider.add("cover.ender_link.ui.io.tooltip", "Input: machine to channel; Output: channel to machine");
        provider.add("cover.ender_link.ui.io.redstone.tooltip", "Input: writes the signal received on this side to the channel; Output: emits the strongest channel signal on this side");
        provider.add("cover.ender_link.ui.back", "Back");
        provider.add("cover.ender_link.ui.list.public", "Public Channels");
        provider.add("cover.ender_link.ui.list.private", "Private Channels");
        provider.add("cover.ender_link.ui.list.empty", "No channels");
        provider.add("cover.ender_link.ui.select", "Select");
        provider.add("cover.ender_link.ui.current", "Current");
        provider.add("cover.ender_link.ui.already_current", "Already the current channel");
        provider.add("cover.ender_link.ui.no_description", "No description");
        provider.add("cover.ender_link.ui.clear_description", "Clear channel description");
        provider.add("cover.ender_link.ui.empty", "Empty");
        provider.add("cover.ender_link.ui.fluid", "Fluid");
        provider.add("cover.ender_link.ui.amount", "Stored");
        provider.add("cover.ender_link.ui.item", "Item");
        provider.add("cover.ender_link.ui.count", "Count");
        provider.add("cover.ender_link.ui.signal", "Channel Signal");
        provider.add("cover.ender_link.ui.members", "Linked Covers");
        provider.add("cover.ender_link.ui.summary.signal", "Signal %s");
        ...
        provider.add("gtceu.recipe.info.link", "Click to open");
