...
public class CraftingRecipeLoader {
    ...
    public static void init() {
        ...
        VanillaRecipeHelper.addShapedRecipe("item_filter", ITEM_FILTER.asStack(), "XXX", "XYX", "XXX", 'X',
                new MaterialEntry(foil, Zinc), 'Y', new MaterialEntry(plate, Steel));
        VanillaRecipeHelper.addShapedRecipe("fluid_filter_lapis", FLUID_FILTER.asStack(), "XXX", "XYX", "XXX",
                'X', new MaterialEntry(foil, Zinc), 'Y', new MaterialEntry(plate, Lapis));
        VanillaRecipeHelper.addShapedRecipe("fluid_filter_lazurite", FLUID_FILTER.asStack(), "XXX", "XYX",
                "XXX", 'X', new MaterialEntry(foil, Zinc), 'Y', new MaterialEntry(plate, Lazurite));
        VanillaRecipeHelper.addShapedRecipe("fluid_filter_sodalite", FLUID_FILTER.asStack(), "XXX", "XYX",
                "XXX", 'X', new MaterialEntry(foil, Zinc), 'Y', new MaterialEntry(plate, Sodalite));

        VanillaRecipeHelper.addShapedRecipe("tag_filter_olivine", TAG_FILTER.asStack(),
                "XXX", "XYX", "XXX", 'X', new MaterialEntry(foil, Zinc), 'Y', new MaterialEntry(plate, Olivine));
        VanillaRecipeHelper.addShapedRecipe("tag_filter_emerald", TAG_FILTER.asStack(),
                "XXX", "XYX", "XXX", 'X', new MaterialEntry(foil, Zinc), 'Y', new MaterialEntry(plate, Emerald));
        VanillaRecipeHelper.addShapedRecipe("fluid_tag_filter", TAG_FLUID_FILTER.asStack(),
                "XXX", "XYX", "XXX", 'X', new MaterialEntry(foil, Zinc), 'Y', new MaterialEntry(plate, Amethyst));

        VanillaRecipeHelper.addShapedRecipe("item_smart_filter_olivine", SMART_ITEM_FILTER.asStack(), "XEX",
                "XCX", "XEX", 'X', new MaterialEntry(foil, Zinc), 'C', CustomTags.LV_CIRCUITS, 'E',
                new MaterialEntry(plate, Ruby));

        VanillaRecipeHelper.addShapedRecipe("plank_to_wooden_shape", WOODEN_FORM_EMPTY.asStack(), "   ",
                " X ", "s  ", 'X', ItemTags.PLANKS);
        VanillaRecipeHelper.addShapedRecipe("wooden_shape_brick", WOODEN_FORM_BRICK.asStack(), "k ", " X",
                'X', WOODEN_FORM_EMPTY.asStack());

        VanillaRecipeHelper.addShapedRecipe("compressed_coke_clay", COMPRESSED_COKE_CLAY.asStack(3), "XXX",
        ...
        VanillaRecipeHelper.addSmeltingRecipe("coke_oven_brick", COMPRESSED_COKE_CLAY.asStack(),
                COKE_OVEN_BRICK.asStack(), 0.3f);
        VanillaRecipeHelper.addSmeltingRecipe("fireclay_brick", COMPRESSED_FIRECLAY.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe("component_grinder_diamond", COMPONENT_GRINDER_DIAMOND.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe("minecart_wheels_iron", IRON_MINECART_WHEELS.asStack(), " h ",
                "RSR", " w ", 'R', new MaterialEntry(ring, Iron), 'S', new MaterialEntry(rod, Iron));
        VanillaRecipeHelper.addShapedRecipe("minecart_wheels_steel", STEEL_MINECART_WHEELS.asStack(), " h ",
                "RSR", " w ", 'R', new MaterialEntry(ring, Steel), 'S', new MaterialEntry(rod, Steel));

        VanillaRecipeHelper.addShapedRecipe("nano_saber", NANO_SABER.asStack(), "PIC", "PIC",
        ...
        VanillaRecipeHelper.addShapedRecipe("solar_panel_basic", COVER_SOLAR_PANEL.asStack(), "WGW", "CPC",
                'W', SILICON_WAFER.asStack(), 'G', new ItemStack(Blocks.GLASS_PANE), 'C', CustomTags.LV_CIRCUITS, 'P',
                CARBON_FIBER_PLATE.asStack());
        VanillaRecipeHelper.addShapedRecipe("solar_panel_ulv", COVER_SOLAR_PANEL_ULV.asStack(), "WGW", "CAC",
        ...
        VanillaRecipeHelper.addShapedRecipe("solar_panel_lv", COVER_SOLAR_PANEL_LV.asStack(), "WGW", "CAC",
        ...
        VanillaRecipeHelper.addShapedRecipe("universal_fluid_cell", FLUID_CELL_UNIVERSAL.asStack(), "C ",
                "  ", 'C', FLUID_CELL);
        VanillaRecipeHelper.addShapedRecipe("universal_fluid_cell_revert", FLUID_CELL.asStack(), "C ", "  ",
                'C', FLUID_CELL_UNIVERSAL);

        VanillaRecipeHelper.addShapedRecipe("blacklight", BLACKLIGHT.asStack(), "SPS", "GRG", "CPK", 'S',
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "filter_casing", GTBlocks.FILTER_CASING.asStack(), "BBB",
        ...
        // Shapes and Molds //
        ///////////////////////////////////////////////////
        VanillaRecipeHelper.addShapedRecipe("shape_empty", SHAPE_EMPTY.asStack(), "hf", "PP", "PP", 'P',
        ...
        // Armors //
        ///////////////////////////////////////////////////
        VanillaRecipeHelper.addShapedRecipe("nightvision_goggles", GTItems.NIGHTVISION_GOGGLES.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe("fluid_jetpack", GTItems.LIQUID_FUEL_JETPACK.asStack(), "xCw",
        ...
        VanillaRecipeHelper.addShapedRecipe("electric_jetpack", GTItems.ELECTRIC_JETPACK.asStack(), "xCd",
        ...
        VanillaRecipeHelper.addShapedRecipe("nano_helmet", GTItems.NANO_HELMET.asStack(), "PPP", "PNP", "xEd",
                'P', GTItems.CARBON_FIBER_PLATE.asStack(), 'N', GTItems.NIGHTVISION_GOGGLES.asStack(), 'E',
                GTItems.ENERGIUM_CRYSTAL.asStack());
        VanillaRecipeHelper.addShapedRecipe("nano_chestplate", GTItems.NANO_CHESTPLATE.asStack(), "PEP",
                "PPP", "PPP", 'P', GTItems.CARBON_FIBER_PLATE.asStack(), 'E', GTItems.ENERGIUM_CRYSTAL.asStack());
        VanillaRecipeHelper.addShapedRecipe("nano_leggings", GTItems.NANO_LEGGINGS.asStack(), "PPP", "PEP",
                "PxP", 'P', GTItems.CARBON_FIBER_PLATE.asStack(), 'E', GTItems.ENERGIUM_CRYSTAL.asStack());
        VanillaRecipeHelper.addShapedRecipe("nano_boots", GTItems.NANO_BOOTS.asStack(), "PxP", "PEP", 'P',
        ...
        VanillaRecipeHelper.addShapedRecipe("gravitation_engine", GTItems.GRAVITATION_ENGINE.asStack(), "ESE",
        ...
        VanillaRecipeHelper.addShapedRecipe("face_mask", FACE_MASK.asStack(), "S S", "PPP", 'S', Items.STRING,
                'P', Items.PAPER);
        VanillaRecipeHelper.addShapedRecipe("rubber_gloves", RUBBER_GLOVES.asStack(), "P P", 'P',
                new MaterialEntry(plate, Rubber));
