...
public class VanillaStandardRecipes {
        ...
        for (DyeColor color : DyeColor.values()) {
            ...
            MIXER_RECIPES.recipeBuilder(dyeName + "_concrete_powder").duration(200).EUt(VA[ULV])
                    ...
                    .outputItems(new ItemStack(
                            BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_concrete_powder")), 8))
                    .save();

            CHEMICAL_BATH_RECIPES.recipeBuilder(dyeName + "_concrete").duration(20).EUt(VA[ULV])
                    .inputItems(new ItemStack(
                            BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_concrete_powder"))))
                    .inputFluids(Water.getFluid(1000))
                    .outputItems(new ItemStack(BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_concrete"))))
            ...
            if (color != DyeColor.WHITE) {
                CHEMICAL_BATH_RECIPES.recipeBuilder("dye_concrete_to_" + dyeName).duration(20).EUt(VA[ULV])
                        ...
                        .outputItems(
                                new ItemStack(BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_concrete"))))
                        .category(GTRecipeCategories.CHEM_DYES)
                        .save();
            }
            ...
            CHEMICAL_BATH_RECIPES.recipeBuilder("dye_terracotta_to_" + dyeName).duration(20).EUt(VA[ULV])
                    ...
                    .inputFluids(CHEMICAL_DYES[color.ordinal()].getFluid(L / 8))
                    .outputItems(
                            new ItemStack(BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_terracotta"))))
                    .category(GTRecipeCategories.CHEM_DYES)
                    .save();
            ...
            CHEMICAL_BATH_RECIPES.recipeBuilder("dye_glass_to_" + dyeName).duration(20).EUt(VA[ULV])
                    ...
                    .inputFluids(CHEMICAL_DYES[color.ordinal()].getFluid(L / 8))
                    .outputItems(
                            new ItemStack(BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_stained_glass"))))
                    .category(GTRecipeCategories.CHEM_DYES)
                    .save();
            ...
            CHEMICAL_BATH_RECIPES.recipeBuilder("dye_glass_pane_to_" + dyeName).duration(20).EUt(VA[ULV])
                    ...
                    .inputFluids(CHEMICAL_DYES[color.ordinal()].getFluid(L / 8))
                    .outputItems(new ItemStack(
                            BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_stained_glass_pane"))))
                    .category(GTRecipeCategories.CHEM_DYES)
                    .save();

            CUTTER_RECIPES.recipeBuilder("cut_" + dyeName + "_glass_to_pane").duration(20).EUt(VA[ULV])
                    .inputItems(BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_stained_glass")), 3)
                    .outputItems(BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_stained_glass_pane")), 8)
                    .save();
            ...
            CHEMICAL_BATH_RECIPES.recipeBuilder("dye_candle_to_" + dyeName).duration(20).EUt(VA[ULV])
                    ...
                    .inputFluids(CHEMICAL_DYES[color.ordinal()].getFluid(L / 8))
                    .outputItems(new ItemStack(
                            BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_candle"))))
                    .category(GTRecipeCategories.CHEM_DYES)
                    .save();
            ...
            if (color != DyeColor.WHITE) {
                CHEMICAL_BATH_RECIPES.recipeBuilder("dye_wool_to_" + dyeName).duration(20).EUt(VA[ULV])
                        ...
                        .inputFluids(CHEMICAL_DYES[color.ordinal()].getFluid(L))
                        .outputItems(new ItemStack(BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_wool"))))
                        .category(GTRecipeCategories.CHEM_DYES)
                        .save();
                ...
                CHEMICAL_BATH_RECIPES.recipeBuilder("dye_bed_to_" + dyeName).duration(20).EUt(VA[ULV])
                        ...
                        .inputFluids(CHEMICAL_DYES[color.ordinal()].getFluid(L))
                        .outputItems(new ItemStack(BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_bed"))))
                        .category(GTRecipeCategories.CHEM_DYES)
                        .save();
            }

            CUTTER_RECIPES.recipeBuilder("cut_" + dyeName + "_wool_to_carpet").duration(20).EUt(VA[ULV])
                    .inputItems(new ItemStack(BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_wool")), 1))
                    .outputItems(
                            new ItemStack(BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_carpet")), 2))
                    .save();

            ASSEMBLER_RECIPES.recipeBuilder(dyeName + "_banner").duration(20).EUt(VA[ULV])
                    .circuitMeta(6)
                    .inputItems(new ItemStack(Items.STICK))
                    .inputItems(new ItemStack(BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_wool")), 6))
                    .outputItems(new ItemStack(BuiltInRegistries.ITEM.get(GTUtil.getResourceLocation(dyeName + "_banner"))))
                    .save();
        }
    ...
    private static void miscRecipes() {
        ...
        ASSEMBLER_RECIPES.recipeBuilder("ender_chest").duration(100).EUt(4)
                ...
                .addMaterialInfo(!ConfigHolder.INSTANCE.recipes.hardMiscRecipes).save();
