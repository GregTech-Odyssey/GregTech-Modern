...
public class MetaTileEntityLoader {
    ...
    public static void init() {
        VanillaRecipeHelper.addShapedRecipe(true, "casing_ulv", GTBlocks.MACHINE_CASING_ULV.asStack(), "PPP",
                "PwP", "PPP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.WroughtIron));
        VanillaRecipeHelper.addShapedRecipe(true, "casing_lv", GTBlocks.MACHINE_CASING_LV.asStack(), "PPP",
                "PwP", "PPP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.Steel));
        VanillaRecipeHelper.addShapedRecipe(true, "casing_mv", GTBlocks.MACHINE_CASING_MV.asStack(), "PPP",
                "PwP", "PPP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.Aluminium));
        VanillaRecipeHelper.addShapedRecipe(true, "casing_hv", GTBlocks.MACHINE_CASING_HV.asStack(), "PPP",
                "PwP", "PPP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.StainlessSteel));
        VanillaRecipeHelper.addShapedRecipe(true, "casing_ev", GTBlocks.MACHINE_CASING_EV.asStack(), "PPP",
                "PwP", "PPP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.Titanium));
        VanillaRecipeHelper.addShapedRecipe(true, "casing_iv", GTBlocks.MACHINE_CASING_IV.asStack(), "PPP",
                "PwP", "PPP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.TungstenSteel));
        VanillaRecipeHelper.addShapedRecipe(true, "casing_luv", GTBlocks.MACHINE_CASING_LuV.asStack(), "PPP",
                "PwP", "PPP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.RhodiumPlatedPalladium));
        VanillaRecipeHelper.addShapedRecipe(true, "casing_zpm", GTBlocks.MACHINE_CASING_ZPM.asStack(), "PPP",
                "PwP", "PPP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.NaquadahAlloy));
        VanillaRecipeHelper.addShapedRecipe(true, "casing_uv", GTBlocks.MACHINE_CASING_UV.asStack(), "PPP",
                "PwP", "PPP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.Darmstadtium));
        VanillaRecipeHelper.addShapedRecipe(true, "casing_uhv", GTBlocks.MACHINE_CASING_UHV.asStack(), "PPP",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "casing_coke_bricks", GTBlocks.CASING_COKE_BRICKS.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "rotor_holder_ev", GTMachines.ROTOR_HOLDER[EV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "rotor_holder_iv", GTMachines.ROTOR_HOLDER[IV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "rotor_holder_luv", GTMachines.ROTOR_HOLDER[LuV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "rotor_holder_zpm", GTMachines.ROTOR_HOLDER[ZPM].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "rotor_holder_uv", GTMachines.ROTOR_HOLDER[UV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "maintenance_hatch", GTMachines.MAINTENANCE_HATCH.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "maintenance_hatch_cleaning",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "bronze_bricks_hull", GTBlocks.BRONZE_BRICKS_HULL.asStack(),
                "PPP", "PhP", "BBB", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.Bronze), 'B',
                new ItemStack(Blocks.BRICKS));
        VanillaRecipeHelper.addShapedRecipe(true, "steel_hull", GTBlocks.STEEL_HULL.asStack(), "PPP", "PhP",
                "PPP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.Steel));
        VanillaRecipeHelper.addShapedRecipe(true, "steel_bricks_hull", GTBlocks.STEEL_BRICKS_HULL.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "steam_compressor_steel",
                ...
                new MaterialEntry(TagPrefix.pipeSmallFluid, GTMaterials.TinAlloy));
        VanillaRecipeHelper.addShapedRecipe(true, "steam_alloy_smelter_bronze",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "coke_oven", GTMultiMachines.COKE_OVEN.asStack(), "PIP",
                "IwI",
                "PIP", 'P', GTBlocks.CASING_COKE_BRICKS.asStack(), 'I',
                new MaterialEntry(TagPrefix.plate, GTMaterials.Iron));
        VanillaRecipeHelper.addShapedRecipe(true, "coke_oven_hatch", GTMachines.COKE_OVEN_HATCH.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "vacuum_freezer", GTMultiMachines.VACUUM_FREEZER.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "cracking_unit", GTMultiMachines.CRACKER.asStack(), "CEC",
                "PHP",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "pyrolyse_oven", GTMultiMachines.PYROLYSE_OVEN.asStack(),
                "WEP",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "extreme_engine_intake_casing",
                ...
                new MaterialEntry(TagPrefix.pipeNormalFluid, GTMaterials.TungstenSteel));
        VanillaRecipeHelper.addShapedRecipe(true, "multi_furnace", GTMultiMachines.MULTI_SMELTER.asStack(),
                "PPP",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "large_plasma_turbine",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "assembly_line", GTMultiMachines.ASSEMBLY_LINE.asStack(),
                "CRC",
        ...
        // GENERATORS
        VanillaRecipeHelper.addShapedRecipe(true, "diesel_generator_lv", GTMachines.COMBUSTION[LV].asStack(),
                ...
                new MaterialEntry(TagPrefix.gear, GTMaterials.Steel));
        VanillaRecipeHelper.addShapedRecipe(true, "diesel_generator_mv", GTMachines.COMBUSTION[MV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "diesel_generator_hv", GTMachines.COMBUSTION[HV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "gas_turbine_lv", GTMachines.GAS_TURBINE[LV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "gas_turbine_mv", GTMachines.GAS_TURBINE[MV].asStack(),
                ...
                new MaterialEntry(TagPrefix.cableGtSingle, GTMaterials.Copper));
        VanillaRecipeHelper.addShapedRecipe(true, "gas_turbine_hv", GTMachines.GAS_TURBINE[HV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "steam_turbine_lv", GTMachines.STEAM_TURBINE[LV].asStack(),
                ...
                new MaterialEntry(TagPrefix.pipeNormalFluid, GTMaterials.Bronze));
        VanillaRecipeHelper.addShapedRecipe(true, "steam_turbine_mv", GTMachines.STEAM_TURBINE[MV].asStack(),
                ...
                new MaterialEntry(TagPrefix.pipeNormalFluid, GTMaterials.Steel));
        VanillaRecipeHelper.addShapedRecipe(true, "steam_turbine_hv", GTMachines.STEAM_TURBINE[HV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "primitive_pump", GTMultiMachines.PRIMITIVE_PUMP.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "pump_hatch", GTMachines.PUMP_HATCH.asStack(), "SRd", "PLP",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "steel_tank_valve",
                ...
                new MaterialEntry(TagPrefix.ring, GTMaterials.Steel), 'C', GTBlocks.CASING_STEEL_SOLID.asStack());
        VanillaRecipeHelper.addShapedRecipe(true, "wood_wall", GTBlocks.CASING_WOOD_WALL.asStack(), "W W",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "wooden_crate", GTMachines.WOODEN_CRATE.asStack(), "RPR",
                "PsP", "RPR", 'P', ItemTags.PLANKS, 'R', new MaterialEntry(TagPrefix.screw, GTMaterials.Iron));
        VanillaRecipeHelper.addShapedRecipe(true, "bronze_crate", GTMachines.BRONZE_CRATE.asStack(), "RPR",
                "PhP", "RPR", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.Bronze), 'R',
                new MaterialEntry(TagPrefix.rodLong, GTMaterials.Bronze));
        VanillaRecipeHelper.addShapedRecipe(true, "steel_crate", GTMachines.STEEL_CRATE.asStack(), "RPR",
                "PhP", "RPR", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.Steel), 'R',
                new MaterialEntry(TagPrefix.rodLong, GTMaterials.Steel));
        VanillaRecipeHelper.addShapedRecipe(true, "aluminium_crate", GTMachines.ALUMINIUM_CRATE.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "titanium_crate", GTMachines.TITANIUM_CRATE.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "wooden_barrel", GTMachines.WOODEN_DRUM.asStack(), "rSs",
                "PRP", "PRP", 'S', GTItems.STICKY_RESIN.asStack(), 'P', ItemTags.PLANKS, 'R',
                new MaterialEntry(TagPrefix.rodLong, GTMaterials.Iron));
        VanillaRecipeHelper.addShapedRecipe(true, "bronze_drum", GTMachines.BRONZE_DRUM.asStack(), " h ",
                "PRP", "PRP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.Bronze), 'R',
                new MaterialEntry(TagPrefix.rodLong, GTMaterials.Bronze));
        VanillaRecipeHelper.addShapedRecipe(true, "steel_drum", GTMachines.STEEL_DRUM.asStack(), " h ", "PRP",
                "PRP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.Steel), 'R',
                new MaterialEntry(TagPrefix.rodLong, GTMaterials.Steel));
        VanillaRecipeHelper.addShapedRecipe(true, "aluminium_drum", GTMachines.ALUMINIUM_DRUM.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "stainless_steel_drum",
                ...
                new MaterialEntry(TagPrefix.plate, GTMaterials.StainlessSteel), 'R',
                new MaterialEntry(TagPrefix.rodLong, GTMaterials.StainlessSteel));
        VanillaRecipeHelper.addShapedRecipe(true, "gold_drum", GTMachines.GOLD_DRUM.asStack(), " h ", "PRP",
                "PRP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.Gold), 'R',
                new MaterialEntry(TagPrefix.rodLong, GTMaterials.Gold));

        // Hermetic Casings
        VanillaRecipeHelper.addShapedRecipe(true, "hermetic_casing_lv", GTBlocks.HERMETIC_CASING_LV.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "hermetic_casing_mv", GTBlocks.HERMETIC_CASING_MV.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "hermetic_casing_hv", GTBlocks.HERMETIC_CASING_HV.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "hermetic_casing_ev", GTBlocks.HERMETIC_CASING_EV.asStack(),
                "PPP", "PFP", "PPP", 'P', new MaterialEntry(TagPrefix.plate, GTMaterials.Titanium), 'F',
                new MaterialEntry(TagPrefix.pipeLargeFluid, GTMaterials.StainlessSteel));
        VanillaRecipeHelper.addShapedRecipe(true, "hermetic_casing_iv", GTBlocks.HERMETIC_CASING_IV.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "hermetic_casing_uv", GTBlocks.HERMETIC_CASING_UV.asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "super_chest_lv", GTMachines.SUPER_CHEST[LV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "super_chest_mv", GTMachines.SUPER_CHEST[MV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "super_chest_hv", GTMachines.SUPER_CHEST[HV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "super_chest_ev", GTMachines.SUPER_CHEST[EV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "quantum_chest_iv", GTMachines.QUANTUM_CHEST[IV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "quantum_chest_uv", GTMachines.QUANTUM_CHEST[UV].asStack(),
        ...
        // Super / Quantum Tanks
        VanillaRecipeHelper.addShapedRecipe(true, "super_tank_lv", GTMachines.SUPER_TANK[LV].asStack(), "CPC",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "super_tank_mv", GTMachines.SUPER_TANK[MV].asStack(), "CPC",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "super_tank_hv", GTMachines.SUPER_TANK[HV].asStack(), "CGC",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "super_tank_ev", GTMachines.SUPER_TANK[EV].asStack(), "CGC",
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "quantum_tank_iv", GTMachines.QUANTUM_TANK[IV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "quantum_tank_luv", GTMachines.QUANTUM_TANK[LuV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "quantum_tank_zpm", GTMachines.QUANTUM_TANK[ZPM].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "quantum_tank_uv", GTMachines.QUANTUM_TANK[UV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "quantum_tank_uhv", GTMachines.QUANTUM_TANK[UHV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(true, "cleanroom", GTMultiMachines.CLEANROOM.asStack(), "FFF",
                "RHR",
    ...
    // - MaterialEntry
    // - TagKey<?>
    public static void registerMachineRecipe(boolean setMaterialInfoData,
        ...
        for (MachineDefinition machine : machines) {
            ...
            if (machine != null) {
                ...
                VanillaRecipeHelper.addShapedRecipe(setMaterialInfoData, machine.getName(), machine.asStack(),
                        prepRecipe);
            }
        }
    }

    public static void registerMachineRecipe(MachineDefinition[] machines,
                                             Object... recipe) {
