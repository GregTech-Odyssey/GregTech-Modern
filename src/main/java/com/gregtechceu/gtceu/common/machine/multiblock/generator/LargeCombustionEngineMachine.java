...
public class LargeCombustionEngineMachine extends WorkableElectricMultiblockMachine {
    ...
    public void attachTooltips(TooltipsPanel tooltipsPanel) {
        ...
        tooltipsPanel.attachTooltips(new IFancyTooltip.Basic(() -> WidgetIcons.STATUS_OBSTRUCTED, () -> List.of(Component.translatable("gtceu.multiblock.large_combustion_engine.obstructed").setStyle(Style.EMPTY.withColor(ChatFormatting.RED))), this::isIntakesObstructed, () -> null));
    }
}
