...
public class ElementMaterials {
    ...
    public static void register() {
        Actinium = GTMaterials.builder("actinium")
                .color(0xC3D1FF).secondaryColor(0x397090).iconSet(METALLIC)
                .element(GTElements.Ac)
                .buildAndRegister();

        Aluminium = GTMaterials.builder("aluminium")
                .ingot()
        ...
        Americium = GTMaterials.builder("americium")
                .ingot(3)
        ...
        Antimony = GTMaterials.builder("antimony")
                .ingot()
        ...
        Argon = GTMaterials.builder("argon")
                .gas().plasma()
                .color(0x00FF00)
                .element(GTElements.Ar)
                .buildAndRegister();

        Arsenic = GTMaterials.builder("arsenic")
                .dust()
        ...
        Bismuth = GTMaterials.builder("bismuth")
                .ingot(1)
        ...
        Cadmium = GTMaterials.builder("cadmium")
                .dust()
        ...
        Cerium = GTMaterials.builder("cerium")
                .dust()
        ...
        Chlorine = GTMaterials.builder("chlorine")
                .gas(new FluidBuilder().state(FluidState.GAS).customStill())
                .element(GTElements.Cl)
                // TODO hazard
                .buildAndRegister();

        Chromium = GTMaterials.builder("chromium")
                .ingot(3)
        ...
        Cobalt = GTMaterials.builder("cobalt")
                .ingot()
        ...
        Curium = GTMaterials.builder("curium")
                .color(0x7B544E).iconSet(RADIOACTIVE)
                .element(GTElements.Cm)
                // .radioactiveHazard(1)
                .buildAndRegister();

        Darmstadtium = GTMaterials.builder("darmstadtium")
                .ingot().fluid()
        ...
        Helium3 = GTMaterials.builder("helium_3")
                .gas(new FluidBuilder()
                        .customStill()
        ...
        Indium = GTMaterials.builder("indium")
                .ingot()
        ...
        Krypton = GTMaterials.builder("krypton")
                .gas(new FluidBuilder()
                        .customStill()
                        .translation("gtceu.fluid.generic"))
                .color(0x80FF80)
        ...
        Lanthanum = GTMaterials.builder("lanthanum")
                .dust()
        ...
        Lawrencium = GTMaterials.builder("lawrencium")
                .color(0x5D7575)
                .iconSet(RADIOACTIVE)
                .element(GTElements.Lr)
                .buildAndRegister();

        Lead = GTMaterials.builder("lead")
                .ingot(1)
        ...
        Lithium = GTMaterials.builder("lithium")
                .dust()
        ...
        Livermorium = GTMaterials.builder("livermorium")
                .color(0x939393).secondaryColor(0xff5e5e).iconSet(RADIOACTIVE)
                .element(GTElements.Lv)
                .buildAndRegister();

        Lutetium = GTMaterials.builder("lutetium")
                .dust()
        ...
        Magnesium = GTMaterials.builder("magnesium")
                .dust()
        ...
        Mendelevium = GTMaterials.builder("mendelevium")
                .color(0x1D4ACF).iconSet(RADIOACTIVE)
                .element(GTElements.Md)
                .buildAndRegister();

        Manganese = GTMaterials.builder("manganese")
                .ingot()
        ...
        Molybdenum = GTMaterials.builder("molybdenum")
                .ingot()
        ...
        Neon = GTMaterials.builder("neon")
                .gas()
                .color(0xFAB4B4)
                .element(GTElements.Ne)
                .buildAndRegister();

        Neptunium = GTMaterials.builder("neptunium")
                .color(0x284D7B).iconSet(RADIOACTIVE)
                .element(GTElements.Np)
                // .radioactiveHazard(1)
                .buildAndRegister();

        Nickel = GTMaterials.builder("nickel")
                .ingot()
        ...
        Oxygen = GTMaterials.builder("oxygen")
                .gas()
                .liquid(new FluidBuilder()
                        .temperature(85)
                        .color(0x6688DD)
        ...
        Palladium = GTMaterials.builder("palladium")
                .ingot().fluid().ore()
        ...
        Phosphorus = GTMaterials.builder("phosphorus")
                .dust()
                .color(0x77332c).secondaryColor(0x220202)
                .element(GTElements.P)
                .buildAndRegister();

        Polonium = GTMaterials.builder("polonium")
        ...
        Platinum = GTMaterials.builder("platinum")
                .ingot()
        ...
        Plutonium239 = GTMaterials.builder("plutonium")
                .ingot(3)
        ...
        Plutonium241 = GTMaterials.builder("plutonium_241")
                .ingot(3)
                .liquid(new FluidBuilder().temperature(913))
        ...
        Potassium = GTMaterials.builder("potassium")
                .dust(1)
        ...
        Praseodymium = GTMaterials.builder("praseodymium")
                .color(0x718060).secondaryColor(0x3f3447).iconSet(METALLIC)
                .element(GTElements.Pr)
                .buildAndRegister();

        Promethium = GTMaterials.builder("promethium")
        ...
        Protactinium = GTMaterials.builder("protactinium")
                .color(0xA78B6D).iconSet(RADIOACTIVE)
                .element(GTElements.Pa)
                // .radioactiveHazard(1)
                .buildAndRegister();

        Radon = GTMaterials.builder("radon")
                .gas()
                .color(0xFF39FF)
        ...
        Rutherfordium = GTMaterials.builder("rutherfordium")
                .color(0x6b6157).secondaryColor(0xFFF6A1).iconSet(RADIOACTIVE)
                .element(GTElements.Rf)
                .buildAndRegister();

        Samarium = GTMaterials.builder("samarium")
                .ingot()
        ...
        Silver = GTMaterials.builder("silver")
                .ingot()
        ...
        Tantalum = GTMaterials.builder("tantalum")
                .ingot()
        ...
        Titanium = GTMaterials.builder("titanium") // todo Ore? Look at EBF recipe here if we do Ti ores
                .ingot(3).fluid()
        ...
        Tritium = GTMaterials.builder("tritium")
                .gas(new FluidBuilder().state(FluidState.GAS).customStill())
        ...
        Tungsten = GTMaterials.builder("tungsten")
                .ingot(3)
        ...
        Uranium238 = GTMaterials.builder("uranium")
                .ingot(3)
        ...
        Uranium235 = GTMaterials.builder("uranium_235")
                .ingot(3)
                .liquid(new FluidBuilder().temperature(1405))
        ...
        Vanadium = GTMaterials.builder("vanadium")
                .ingot().fluid()
        ...
        Xenon = GTMaterials.builder("xenon")
                .gas()
                .color(0x00FFFF)
                .element(GTElements.Xe)
                .buildAndRegister();

        Ytterbium = GTMaterials.builder("ytterbium")
                .color(0xA7A7A7).iconSet(METALLIC)
                .element(GTElements.Yb)
                .buildAndRegister();

        Yttrium = GTMaterials.builder("yttrium")
                .ingot().fluid()
        ...
        Zirconium = GTMaterials.builder("zirconium")
                .color(0xb99b7e).secondaryColor(0x271813).iconSet(METALLIC)
                .element(GTElements.Zr)
                .buildAndRegister();

        Naquadah = GTMaterials.builder("naquadah")
                .ingot(4)
        ...
        NaquadahEnriched = GTMaterials.builder("enriched_naquadah")
                .ingot(4)
                .liquid(new FluidBuilder().customStill())
        ...
        Naquadria = GTMaterials.builder("naquadria")
                .ingot(3)
                .liquid(new FluidBuilder().customStill())
        ...
        Neutronium = GTMaterials.builder("neutronium")
                .ingot(6)
        ...
        Tritanium = GTMaterials.builder("tritanium")
                .ingot(6)
        ...
        Duranium = GTMaterials.builder("duranium")
                .ingot(5)
        ...
        Trinium = GTMaterials.builder("trinium")
                .ingot(7).fluid()
