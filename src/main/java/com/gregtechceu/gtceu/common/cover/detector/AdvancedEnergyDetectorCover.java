...
public class AdvancedEnergyDetectorCover extends EnergyDetectorCover implements IUICover {
    ...
    public Widget createUIWidget() {
        ...
        group.addWidget(new ToggleButtonWidget(9, 20, 20, 20, GuiTextures.INVERT_REDSTONE_BUTTON, this::isInverted, this::setInverted).isMultiLang().setTooltipText("cover.advanced_energy_detector.invert"));
        // Mode (EU / Percent) Toggle:
        group.addWidget(new ToggleButtonWidget(176 - 29, 20, 20, 20, GuiTextures.ENERGY_DETECTOR_COVER_MODE_BUTTON, this::isUsePercent, this::setUsePercent).isMultiLang().setTooltipText("cover.advanced_energy_detector.use_percent"));
        return group;
    }

    private void initializeMinMaxInputs(boolean wasPercent) {
        if (GTCEu.isClientThread() || minValueInput == null || maxValueInput == null) return;
        long energyCapacity;
        try {
