...
public class NotifiableFluidTank extends NotifiableRecipeHandlerTrait<FluidIngredient> implements ICapabilityTrait, IFluidHandlerModifiable {
    ...
    public void exportToNearby(@NotNull Direction... facings) {
        ...
        for (Direction facing : facings) {
            ...
            machine.fluidHandlerDirectionCache.getAdjacentFluidHandler(level, pos, facing).ifPresent(adj -> GTTransferUtils.transferFluidsFiltered(this, adj, filter));
        }
    }
    ...
    public void importFromNearby(@NotNull Direction... facings) {
        ...
        for (Direction facing : facings) {
            ...
            machine.fluidHandlerDirectionCache.getAdjacentFluidHandler(level, pos, facing).ifPresent(adj -> GTTransferUtils.transferFluidsFiltered(adj, this, filter));
        }
    }
