...
public final class SteamEnergyContainer implements IEnergyContainer.IDummyContainer {
    ...
    public long getEnergyCapacity() {
        return (long) (steamTank.getStorages()[0].getCapacity() / conversionRate);
    }

    public int getStored() {
        return steamTank.getFluidInTank(0).getAmount();
    }

    public int getCapacity() {
        return steamTank.getStorages()[0].getCapacity();
    }
}
