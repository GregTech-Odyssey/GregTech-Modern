...
public abstract class VirtualEntry implements INBTSerializable<CompoundTag>, ITagSerializable<CompoundTag> {
    ...
    public CompoundTag serializeNBT() {
        ...
        if (!description.isEmpty()) tag.putString(DESC_KEY, this.description);
        return tag;
    }
    ...
    public void deserializeNBT(CompoundTag nbt) {
        ...
        if (nbt.contains(DESC_KEY)) this.description = nbt.getString(DESC_KEY);
    }
     ...
     * @return {@code this}.
     */
    public VirtualEntry setDescription(@NotNull final String description) {
        if (description == null) {
