...
public class GTOreDefinition {
    ...
    public VeinGenerator veinGenerator(ResourceLocation id) {
        if (veinGenerator == null) {
            veinGenerator = (VeinGenerator) WorldGeneratorUtils.VEIN_GENERATOR_FUNCTIONS.getOrDefault(id, GTUtil.NULL_FUNCTION).apply(this);
        }
